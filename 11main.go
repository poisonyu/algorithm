...
func main() {
	...
	// a := []int{11, 100, 12, 24, 20, 42, 40, 211, 232, 134}
	// fmt.Println(a)
	// // heapSort(&a)
	// // bucketSort(a)
	// // countingSortDigit(a)
	...
	// size_btc = float32(margin / (liq_price - entry_price))
	// size_usdt = int(size_btc) * entry_price
	// leverage = size_usdt / margin
	// print(size_btc, size_usdt, leverage)
	// fmt.Print(size_btc, size_usdt, leverage)
	// size_btc = float32(margin / (liq_price - entry_price))
	size_usdt = int(size_btc) * entry_price
	leverage = size_usdt / margin
	print(size_btc, size_usdt, leverage)
